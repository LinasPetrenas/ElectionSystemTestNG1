...
/**
 * Class for having all functions which required for Selenium Page Object:
 * waits, setters, getters Created by pauliusl on 2016-12-19.
 */
public class PageObject {
	...
	/**
	 * Base URL of the server. Valid value example:
	...
	public PageObject(WebDriver webDriver, String baseUrl) {
		...
		//System.out.println("Page Factory works in " + this.getClass().getName());
	 ...
	 * @author jurijk
	 */
	public void setDropDownMenu(WebElement element, WebElement field, String item) {
		...
		try {
			...
			setTextFieldValueWithClear(field, item);
		} catch (Exception e) {
	 ...
	 * @author nelig+jurijk
	 */
	public void setDropDownListByVisibleText(WebElement element, WebElement field, String visibleText) {
		...
		try {
			...
			selectFromDropDown(field, visibleText);
		} catch (Exception e) {
			System.out.println("Error: " + e);
		}
	}
	 ...
	 * @param value
	 */
	public void setDropDownList(WebElement element, WebElement field, String value) {
		...
		try {
			...
			selectFromDropDownByValue(field, value);
		} catch (Exception e) {
			System.out.println("Error: " + e);
		}
	}
	...
	/**
	 * Upload file using windows form
	 * 
	 * @param filePath to upload
	 * @param button to browse
	 */
	public void attachFile(String filePath, WebElement button)  {
	...
	/**
	 * Scroll to webElement with a given offset from the element
	 * 
	 * @param webElement
	 * @param x
	 *            horizontal offset
	 * @param y
	 *            vertical offset (positive scroll down, negative scroll up)
	 * 
	 */
	public void scrollToWebElement(WebElement element, int x, int y) {

		String script = "window.scroll(" + (element.getLocation().x + x) + "," + (element.getLocation().y + y) + ");";
		((JavascriptExecutor) webDriver).executeScript(script, element, x, y);
	}
	...
	public void clickLink(WebElement element) {
		...
		try {
			...
			System.out.println("Link " + element + " not presented");
		}
	}
	...
	public void clickButton(WebElement element) {
		...
		try {
			...
			System.out.println("Button " + element + " not presented");
		}
	}
	...
	public void clickButton(String xpath) {
		...
		try {
			...
			System.out.println("Button " + xpath + "not presented");
		}
	}

	// Asserts
	public void assertElementIsDisplayed(WebElement element, String assertMessage) {

		waitForElementToBeInDOM(element);
		Assert.assertEquals(isElementDisplayed(element), true, assertMessage);
	}
}
